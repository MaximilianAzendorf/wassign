...
private:
    ...
    /**
     * Returns a single neighbor generated by swapping the slots of two or more random choices.
     */
    shared_ptr<Scheduling const> random_swap_neighbor(shared_ptr<Scheduling const> const& scheduling);
