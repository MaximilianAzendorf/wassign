...
vector<int>
SchedulingSolver::calculate_feasible_slots(map<int, int> const& decisions, vector<bool> const& lowPrioritySlot,
                                           int workshop)
{
...
vector<bool> SchedulingSolver::get_low_priority_slot_map()
{
