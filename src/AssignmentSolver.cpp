...
shared_ptr<Assignment const> AssignmentSolver::solve(shared_ptr<Scheduling const> const& scheduling)
{
...
AssignmentSolver::AssignmentSolver(InputData const& inputData,
